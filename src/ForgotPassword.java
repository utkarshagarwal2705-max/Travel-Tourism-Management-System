...
{
    private JTextField tfname,tfusername,tfquestion,tfanswer,tfpassword;
    ...
    ForgotPassword()
    {
        ...
        lblquestion.setFont(new Font("Dialog",Font.BOLD,15));
        p1.add(lblquestion);
        ...
        retrieve.setFont(new Font("Dialog",Font.BOLD,15));
